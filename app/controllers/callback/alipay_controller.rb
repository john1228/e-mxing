module Callback
  class AlipayController < BaseController
    def callback
      ...
      Transaction.create(no: trande_no, order_no: order_no, buyer_id: buyer_id, buyer_email: buyer_email, source: Transaction::SOURCE[:alipay], price: pay_amount)
      render text: 'success'
    end
  end
end
